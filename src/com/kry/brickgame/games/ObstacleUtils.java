...
import static com.kry.brickgame.games.Game.r;
...
public enum ObstacleUtils {
	...
	private static Board generateObstacle(Board board, int type, int leftBorderSpace,
		...
		if (k > 0) return drawShape(board, x, y, obstacle, Cell.Full);
		return board;
	}
	 ...
	 */
	static Board getPreparedObstacles(Board board, PlacedObstacle[] obstacles) {
		Board result = board;
	 ...
	 * @return board with the obstacles
	 */
	static Board getRandomObstacles(Board board, int count, int leftBorderSpace,
	        int rightBorderSpace, int bottomBorderSpace, int topBorderSpace) {
		Board result = board;
	...
	static PlacedObstacle[][] getSnakeObstacles() {
		return snakeObstacles;
	}
	
	static PlacedObstacle[][] getTanksObstacles() {
		return tanksObstacles;
	}
